...
$txt['redirector_check_referrer_sub'] = 'Сделает невозможным использование сторонними сайтами редиректа вашего форума в своих целях. Но, может сделать нерабочими ссылки через редирект на вашем форуме в некоторых случаях. Например, для Tapatalk или SSI.';
